...
unless(defined(&__ASM_GENERIC_SOCKET_H)) {
    ...
    eval 'sub SO_PASSPIDFD () {76;}' unless defined(&SO_PASSPIDFD);
    eval 'sub SO_PEERPIDFD () {77;}' unless defined(&SO_PEERPIDFD);
    eval 'sub SO_DEVMEM_LINEAR () {78;}' unless defined(&SO_DEVMEM_LINEAR);
    eval 'sub SCM_DEVMEM_LINEAR () { &SO_DEVMEM_LINEAR;}' unless defined(&SCM_DEVMEM_LINEAR);
    eval 'sub SO_DEVMEM_DMABUF () {79;}' unless defined(&SO_DEVMEM_DMABUF);
    eval 'sub SCM_DEVMEM_DMABUF () { &SO_DEVMEM_DMABUF;}' unless defined(&SCM_DEVMEM_DMABUF);
    eval 'sub SO_DEVMEM_DONTNEED () {80;}' unless defined(&SO_DEVMEM_DONTNEED);
