...
unless(defined(&_ASM_UNISTD_X32_H)) {
    ...
    eval 'sub __NR_uretprobe () {( &__X32_SYSCALL_BIT + 335);}' unless defined(&__NR_uretprobe);
    ...
    eval 'sub __NR_map_shadow_stack () {( &__X32_SYSCALL_BIT + 453);}' unless defined(&__NR_map_shadow_stack);
    ...
    eval 'sub __NR_mseal () {( &__X32_SYSCALL_BIT + 462);}' unless defined(&__NR_mseal);
