...
unless(defined(&_FEATURES_H)) {
    ...
    undef(&__GLIBC_USE_ISOC23) if defined(&__GLIBC_USE_ISOC23);
    undef(&__GLIBC_USE_ISOC2Y) if defined(&__GLIBC_USE_ISOC2Y);
    ...
    undef(&__GLIBC_USE_C23_STRTOL) if defined(&__GLIBC_USE_C23_STRTOL);
	...
	undef(&_ISOC23_SOURCE) if defined(&_ISOC23_SOURCE);
	eval 'sub _ISOC23_SOURCE () {1;}' unless defined(&_ISOC23_SOURCE);
    }
	...
	undef(&_ISOC23_SOURCE) if defined(&_ISOC23_SOURCE);
	eval 'sub _ISOC23_SOURCE () {1;}' unless defined(&_ISOC23_SOURCE);
	undef(&_ISOC2Y_SOURCE) if defined(&_ISOC2Y_SOURCE);
	eval 'sub _ISOC2Y_SOURCE () {1;}' unless defined(&_ISOC2Y_SOURCE);
    ...
    if((defined (&_DEFAULT_SOURCE) || (!defined (&__STRICT_ANSI__)  && !defined (&_ISOC99_SOURCE)  && !defined (&_ISOC11_SOURCE)  && !defined (&_ISOC23_SOURCE)  && !defined (&_ISOC2Y_SOURCE)  && !defined (&_POSIX_SOURCE)  && !defined (&_POSIX_C_SOURCE)  && !defined (&_XOPEN_SOURCE)))) {
	undef(&_DEFAULT_SOURCE) if defined(&_DEFAULT_SOURCE);
	eval 'sub _DEFAULT_SOURCE () {1;}' unless defined(&_DEFAULT_SOURCE);
    }
    if((defined (&_ISOC2Y_SOURCE) || (defined (&__STDC_VERSION__)  && (defined(&__STDC_VERSION__) ? &__STDC_VERSION__ : undef) > 202311))) {
	eval 'sub __GLIBC_USE_ISOC2Y () {1;}' unless defined(&__GLIBC_USE_ISOC2Y);
    } else {
	eval 'sub __GLIBC_USE_ISOC2Y () {0;}' unless defined(&__GLIBC_USE_ISOC2Y);
    }
    if((defined (&_ISOC23_SOURCE) || defined (&_ISOC2Y_SOURCE) || (defined (&__STDC_VERSION__)  && (defined(&__STDC_VERSION__) ? &__STDC_VERSION__ : undef) > 201710))) {
	eval 'sub __GLIBC_USE_ISOC23 () {1;}' unless defined(&__GLIBC_USE_ISOC23);
    } else {
	eval 'sub __GLIBC_USE_ISOC23 () {0;}' unless defined(&__GLIBC_USE_ISOC23);
    }
    if((defined (&_ISOC11_SOURCE) || defined (&_ISOC23_SOURCE) || defined (&_ISOC2Y_SOURCE) || (defined (&__STDC_VERSION__)  && (defined(&__STDC_VERSION__) ? &__STDC_VERSION__ : undef) >= 201112))) {
	eval 'sub __USE_ISOC11 () {1;}' unless defined(&__USE_ISOC11);
    }
    if((defined (&_ISOC99_SOURCE) || defined (&_ISOC11_SOURCE) || defined (&_ISOC23_SOURCE) || defined (&_ISOC2Y_SOURCE) || (defined (&__STDC_VERSION__)  && (defined(&__STDC_VERSION__) ? &__STDC_VERSION__ : undef) >= 199901))) {
	eval 'sub __USE_ISOC99 () {1;}' unless defined(&__USE_ISOC99);
    }
    if((defined (&_ISOC99_SOURCE) || defined (&_ISOC11_SOURCE) || defined (&_ISOC23_SOURCE) || defined (&_ISOC2Y_SOURCE) || (defined (&__STDC_VERSION__)  && (defined(&__STDC_VERSION__) ? &__STDC_VERSION__ : undef) >= 199409))) {
    ...
    if( &__GLIBC_USE ((defined(&ISOC23) ? &ISOC23 : undef))) {
	eval 'sub __GLIBC_USE_C23_STRTOL () {1;}' unless defined(&__GLIBC_USE_C23_STRTOL);
    } else {
	eval 'sub __GLIBC_USE_C23_STRTOL () {0;}' unless defined(&__GLIBC_USE_C23_STRTOL);
    }
    ...
    eval 'sub __GLIBC_MINOR__ () {41;}' unless defined(&__GLIBC_MINOR__);
