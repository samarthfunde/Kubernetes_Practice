...
build_time_vars = {
    ...
    'BLDSHARED': 'x86_64-linux-gnu-gcc -shared -Wl,-O1 -Wl,-Bsymbolic-functions  -Wl,-z,relro -g -fwrapv -O2   ',
    'BOOTSTRAP_HEADERS': '\\',
    'BUILDEXE': '',
    'BUILDPYTHON': 'python',
    ...
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/build/reproducible-path/python3.13-3.13.5/build-shared/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/build/reproducible-path/python3.13-3.13.5/build-shared/lcov-report',
    ...
    'JIT_DEPS': '\\',
    'LDCXXSHARED': 'x86_64-linux-gnu-g++ -shared -Wl,-O1 -Wl,-Bsymbolic-functions  -Wl,-z,relro -g -fwrapv -O2   ',
    'LDFLAGS': ' -Wl,-z,relro -g -fwrapv -O2   ',
    'LDFLAGS_NODIST': '',
    'LDLIBRARY': 'libpython3.13.so',
    'LDLIBRARYDIR': '',
    'LDSHARED': 'x86_64-linux-gnu-gcc -shared -Wl,-O1 -Wl,-Bsymbolic-functions  -Wl,-z,relro -g -fwrapv -O2   ',
    'LDVERSION': '3.13',
    'LIBC': '',
    'LIBDEST': '/usr/lib/python3.13',
    'LIBDIR': '/usr/lib/x86_64-linux-gnu',
    'LIBEXPAT_A': 'Modules/expat/libexpat.a',
    'LIBEXPAT_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O2 -Wall -Wdate-time -D_FORTIFY_SOURCE=2 -g -Werror=implicit-function-declaration   -fstack-protector -fstack-clash-protection -Wformat -Werror=format-security -fcf-protection  -g -fwrapv -O2    -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../Include/internal -I../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../Include -fPIC -fPIC',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    'LIBHACL_CFLAGS': '-I../Modules/_hacl/include -D_BSD_SOURCE -D_DEFAULT_SOURCE -fno-strict-overflow -Wsign-compare -DNDEBUG -g -O2 -Wall -Wdate-time -D_FORTIFY_SOURCE=2 -g -Werror=implicit-function-declaration   -fstack-protector -fstack-clash-protection -Wformat -Werror=format-security -fcf-protection  -g -fwrapv -O2    -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../Include/internal -I../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../Include -fPIC -fPIC',
    'LIBHACL_HEADERS': '\\',
    ...
    'LIBMPDEC_CFLAGS': '-I../Modules/_decimal/libmpdec -DCONFIG_64=1 -DANSI=1 -DHAVE_UINT128_T=1 -fno-strict-overflow -Wsign-compare -DNDEBUG -g -O2 -Wall -Wdate-time -D_FORTIFY_SOURCE=2 -g -Werror=implicit-function-declaration   -fstack-protector -fstack-clash-protection -Wformat -Werror=format-security -fcf-protection  -g -fwrapv -O2    -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../Include/internal -I../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../Include -fPIC -fPIC',
    'LIBMPDEC_HEADERS': '\\',
    'LIBMPDEC_OBJS': '\\',
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    ...
    'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O2 -Wall -Wdate-time -D_FORTIFY_SOURCE=2 -g -Werror=implicit-function-declaration   -fstack-protector -fstack-clash-protection -Wformat -Werror=format-security -fcf-protection  -g -fwrapv -O2    -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../Include/internal -I../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../Include -fPIC -DPy_BUILD_CORE_BUILTIN',
    'PY_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O2 -Wall',
    'PY_CFLAGS_NODIST': '-Wdate-time -D_FORTIFY_SOURCE=2 -g -Werror=implicit-function-declaration   -fstack-protector -fstack-clash-protection -Wformat -Werror=format-security -fcf-protection  -g -fwrapv -O2    -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../Include/internal -I../Include/internal/mimalloc',
    'PY_COERCE_C_LOCALE': 1,
    'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O2 -Wall -Wdate-time -D_FORTIFY_SOURCE=2 -g -Werror=implicit-function-declaration   -fstack-protector -fstack-clash-protection -Wformat -Werror=format-security -fcf-protection  -g -fwrapv -O2    -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../Include/internal -I../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../Include -fPIC -DPy_BUILD_CORE',
    ...
    'PY_STDMODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O2 -Wall -Wdate-time -D_FORTIFY_SOURCE=2 -g -Werror=implicit-function-declaration   -fstack-protector -fstack-clash-protection -Wformat -Werror=format-security -fcf-protection  -g -fwrapv -O2    -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../Include/internal -I../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../Include -fPIC',
    'PY_SUPPORT_TIER': 1,
    'Py_DEBUG': 0,
    'Py_ENABLE_SHARED': 1,
    'Py_GIL_DISABLED': 0,
