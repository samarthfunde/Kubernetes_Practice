...
eval 'sub __GLIBC_LINUX_VERSION_CODE () {396288;}' unless defined(&__GLIBC_LINUX_VERSION_CODE);
...
if(defined(&__NR_cachestat)) {
    eval 'sub SYS_cachestat () { &__NR_cachestat;}' unless defined(&SYS_cachestat);
}
...
if(defined(&__NR_fchmodat2)) {
    eval 'sub SYS_fchmodat2 () { &__NR_fchmodat2;}' unless defined(&SYS_fchmodat2);
}
...
if(defined(&__NR_futex_requeue)) {
    eval 'sub SYS_futex_requeue () { &__NR_futex_requeue;}' unless defined(&SYS_futex_requeue);
}
if(defined(&__NR_futex_time64)) {
    eval 'sub SYS_futex_time64 () { &__NR_futex_time64;}' unless defined(&SYS_futex_time64);
}
if(defined(&__NR_futex_wait)) {
    eval 'sub SYS_futex_wait () { &__NR_futex_wait;}' unless defined(&SYS_futex_wait);
}
...
if(defined(&__NR_futex_wake)) {
    eval 'sub SYS_futex_wake () { &__NR_futex_wake;}' unless defined(&SYS_futex_wake);
}
...
if(defined(&__NR_listmount)) {
    eval 'sub SYS_listmount () { &__NR_listmount;}' unless defined(&SYS_listmount);
}
...
if(defined(&__NR_lsm_get_self_attr)) {
    eval 'sub SYS_lsm_get_self_attr () { &__NR_lsm_get_self_attr;}' unless defined(&SYS_lsm_get_self_attr);
}
if(defined(&__NR_lsm_list_modules)) {
    eval 'sub SYS_lsm_list_modules () { &__NR_lsm_list_modules;}' unless defined(&SYS_lsm_list_modules);
}
if(defined(&__NR_lsm_set_self_attr)) {
    eval 'sub SYS_lsm_set_self_attr () { &__NR_lsm_set_self_attr;}' unless defined(&SYS_lsm_set_self_attr);
}
...
if(defined(&__NR_map_shadow_stack)) {
    eval 'sub SYS_map_shadow_stack () { &__NR_map_shadow_stack;}' unless defined(&SYS_map_shadow_stack);
}
...
if(defined(&__NR_mseal)) {
    eval 'sub SYS_mseal () { &__NR_mseal;}' unless defined(&SYS_mseal);
}
...
if(defined(&__NR_riscv_hwprobe)) {
    eval 'sub SYS_riscv_hwprobe () { &__NR_riscv_hwprobe;}' unless defined(&SYS_riscv_hwprobe);
}
...
if(defined(&__NR_statmount)) {
    eval 'sub SYS_statmount () { &__NR_statmount;}' unless defined(&SYS_statmount);
}
...
if(defined(&__NR_uretprobe)) {
    eval 'sub SYS_uretprobe () { &__NR_uretprobe;}' unless defined(&SYS_uretprobe);
}
