...
unless(defined(&_SYS_CDEFS_H)) {
	...
	if(!defined (&__cplusplus)  && ( &__GNUC_PREREQ (3, 4) ||  &__glibc_has_attribute ((defined(&__nothrow__) ? &__nothrow__ : undef)))) {
	    ...
	    if(defined (&__cplusplus)  && ( &__GNUC_PREREQ (2,8) || (defined(&__clang_major__) ? &__clang_major__ : undef) >= 4)) {
	...
	if( &__GNUC_PREREQ (4, 3) ||  &__glibc_has_attribute ((defined(&__cold__) ? &__cold__ : undef))) {
	    eval 'sub __COLD () { &__attribute__ (( &__cold__));}' unless defined(&__COLD);
	} else {
	    eval 'sub __COLD () {1;}' unless defined(&__COLD);
	}
    } else {
    ...
    if(defined (&__clang_major__)  && ((defined(&__clang_major__) ? &__clang_major__ : undef) + ((defined(&__clang_minor__) ? &__clang_minor__ : undef) >= 6) > 2)) {
	eval 'sub __attribute_overloadable__ () { &__attribute__(( &__overloadable__));}' unless defined(&__attribute_overloadable__);
    } else {
	eval 'sub __attribute_overloadable__ () {1;}' unless defined(&__attribute_overloadable__);
    }
    eval 'sub __bos {
        my($ptr) = @_;
	...
	if(defined (&__clang_major__)  && (defined(&__clang_major__) ? &__clang_major__ : undef) >= 5) {
	    eval 'sub __fortify_use_clang () {1;}' unless defined(&__fortify_use_clang);
	    eval 'sub __fortify_function_error_function () { &static  &__attribute__(( &__unused__));}' unless defined(&__fortify_function_error_function);
	    eval 'sub __fortify_clang_pass_object_size_n {
	        my($n) = @_;
    		eval q( &__attribute__ (( &__pass_object_size__ ($n))));
	    }' unless defined(&__fortify_clang_pass_object_size_n);
	    eval 'sub __fortify_clang_pass_object_size0 () { &__fortify_clang_pass_object_size_n (0);}' unless defined(&__fortify_clang_pass_object_size0);
	    eval 'sub __fortify_clang_pass_object_size () { &__fortify_clang_pass_object_size_n ( &__USE_FORTIFY_LEVEL > 1);}' unless defined(&__fortify_clang_pass_object_size);
	    if((defined(&__clang_major__) ? &__clang_major__ : undef) >= 9) {
		eval 'sub __fortify_clang_pass_dynamic_object_size_n {
		    my($n) = @_;
    		    eval q( &__attribute__ (( &__pass_dynamic_object_size__ ($n))));
		}' unless defined(&__fortify_clang_pass_dynamic_object_size_n);
		eval 'sub __fortify_clang_pass_dynamic_object_size0 () { &__fortify_clang_pass_dynamic_object_size_n (0);}' unless defined(&__fortify_clang_pass_dynamic_object_size0);
		eval 'sub __fortify_clang_pass_dynamic_object_size () { &__fortify_clang_pass_dynamic_object_size_n (1);}' unless defined(&__fortify_clang_pass_dynamic_object_size);
	    } else {
		eval 'sub __fortify_clang_pass_dynamic_object_size_n {
		    my($n) = @_;
    		    eval q();
		}' unless defined(&__fortify_clang_pass_dynamic_object_size_n);
		eval 'sub __fortify_clang_pass_dynamic_object_size0 () {1;}' unless defined(&__fortify_clang_pass_dynamic_object_size0);
		eval 'sub __fortify_clang_pass_dynamic_object_size () {1;}' unless defined(&__fortify_clang_pass_dynamic_object_size);
	    }
	    eval 'sub __fortify_clang_bos_static_lt_impl {
	        my($bos_val, $n, $s) = @_;
    		eval q((($bos_val) != -1  && ($n) > ($bos_val) / ($s)));
	    }' unless defined(&__fortify_clang_bos_static_lt_impl);
	    eval 'sub __fortify_clang_bos_static_lt2 {
	        my($__n, $__e, $__s) = @_;
    		eval q( &__fortify_clang_bos_static_lt_impl ( &__bos ($__e), $__n, $__s));
	    }' unless defined(&__fortify_clang_bos_static_lt2);
	    eval 'sub __fortify_clang_bos_static_lt {
	        my($__n, $__e) = @_;
    		eval q( &__fortify_clang_bos_static_lt2 ($__n, $__e, 1));
	    }' unless defined(&__fortify_clang_bos_static_lt);
	    eval 'sub __fortify_clang_bos0_static_lt2 {
	        my($__n, $__e, $__s) = @_;
    		eval q( &__fortify_clang_bos_static_lt_impl ( &__bos0 ($__e), $__n, $__s));
	    }' unless defined(&__fortify_clang_bos0_static_lt2);
	    eval 'sub __fortify_clang_bos0_static_lt {
	        my($__n, $__e) = @_;
    		eval q( &__fortify_clang_bos0_static_lt2 ($__n, $__e, 1));
	    }' unless defined(&__fortify_clang_bos0_static_lt);
	    eval 'sub __fortify_clang_bosn_args {
	        my($bos_fn, $n, $buf, $div, $complaint) = @_;
    		eval q(( &__fortify_clang_bos_static_lt_impl ($bos_fn ($buf), $n, $div)), ($complaint), \\"warning\\");
	    }' unless defined(&__fortify_clang_bosn_args);
	    eval 'sub __fortify_clang_warning {
	        my($__c, $__msg) = @_;
    		eval q( &__attribute__ (( &__diagnose_if__ (($__c), ($__msg), \\"warning\\"))));
	    }' unless defined(&__fortify_clang_warning);
	    eval 'sub __fortify_clang_error {
	        my($__c, $__msg) = @_;
    		eval q( &__attribute__ (( &__diagnose_if__ (($__c), ($__msg), \\"error\\"))));
	    }' unless defined(&__fortify_clang_error);
	    eval 'sub __fortify_clang_warning_only_if_bos0_lt {
	        my($n, $buf, $complaint) = @_;
    		eval q( &__attribute__ (( &__diagnose_if__ ( &__fortify_clang_bosn_args ( &__bos0, $n, $buf, 1, $complaint)))));
	    }' unless defined(&__fortify_clang_warning_only_if_bos0_lt);
	    eval 'sub __fortify_clang_warning_only_if_bos0_lt2 {
	        my($n, $buf, $div, $complaint) = @_;
    		eval q( &__attribute__ (( &__diagnose_if__ ( &__fortify_clang_bosn_args ( &__bos0, $n, $buf, $div, $complaint)))));
	    }' unless defined(&__fortify_clang_warning_only_if_bos0_lt2);
	    eval 'sub __fortify_clang_warning_only_if_bos_lt {
	        my($n, $buf, $complaint) = @_;
    		eval q( &__attribute__ (( &__diagnose_if__ ( &__fortify_clang_bosn_args ( &__bos, $n, $buf, 1, $complaint)))));
	    }' unless defined(&__fortify_clang_warning_only_if_bos_lt);
	    eval 'sub __fortify_clang_warning_only_if_bos_lt2 {
	        my($n, $buf, $div, $complaint) = @_;
    		eval q( &__attribute__ (( &__diagnose_if__ ( &__fortify_clang_bosn_args ( &__bos, $n, $buf, $div, $complaint)))));
	    }' unless defined(&__fortify_clang_warning_only_if_bos_lt2);
	    eval 'sub __fortify_clang_prefer_this_overload () { &__attribute__ (( &enable_if (1, "")));}' unless defined(&__fortify_clang_prefer_this_overload);
	    eval 'sub __fortify_clang_unavailable {
	        my($__msg) = @_;
    		eval q( &__attribute__ (( &unavailable($__msg))));
	    }' unless defined(&__fortify_clang_unavailable);
	    if((defined(&__USE_FORTIFY_LEVEL) ? &__USE_FORTIFY_LEVEL : undef) == 3) {
		eval 'sub __fortify_clang_overload_arg {
		    my($__type, $__attr, $__name) = @_;
    		    eval q($__type $__attr  &const  &__fortify_clang_pass_dynamic_object_size $__name);
		}' unless defined(&__fortify_clang_overload_arg);
		eval 'sub __fortify_clang_overload_arg0 {
		    my($__type, $__attr, $__name) = @_;
    		    eval q($__type $__attr  &const  &__fortify_clang_pass_dynamic_object_size0 $__name);
		}' unless defined(&__fortify_clang_overload_arg0);
	    } else {
		eval 'sub __fortify_clang_overload_arg {
		    my($__type, $__attr, $__name) = @_;
    		    eval q($__type $__attr  &const  &__fortify_clang_pass_object_size $__name);
		}' unless defined(&__fortify_clang_overload_arg);
		eval 'sub __fortify_clang_overload_arg0 {
		    my($__type, $__attr, $__name) = @_;
    		    eval q($__type $__attr  &const  &__fortify_clang_pass_object_size0 $__name);
		}' unless defined(&__fortify_clang_overload_arg0);
	    }
	    eval 'sub __fortify_clang_mul_may_overflow {
	        my($size, $n) = @_;
    		eval q((($size | $n) >= ((1) << (8* $sizeof{\'size_t\'} / 2))));
	    }' unless defined(&__fortify_clang_mul_may_overflow);
	    eval 'sub __fortify_clang_size_too_small {
	        my($__bos, $__dest, $__len) = @_;
    		eval q(($__bos ($__dest) !=  -1 && $__bos ($__dest) < $__len));
	    }' unless defined(&__fortify_clang_size_too_small);
	    eval 'sub __fortify_clang_warn_if_src_too_large {
	        my($__dest, $__src) = @_;
    		eval q( &__fortify_clang_warning ( &__fortify_clang_size_too_small ( &__glibc_objsize, $__dest,  &__builtin_strlen ($__src) + 1), \\"destination buffer will always be overflown by source\\"));
	    }' unless defined(&__fortify_clang_warn_if_src_too_large);
	    eval 'sub __fortify_clang_warn_if_dest_too_small {
	        my($__dest, $__len) = @_;
    		eval q( &__fortify_clang_warning ( &__fortify_clang_size_too_small ( &__glibc_objsize, $__dest, $__len), \\"function called with bigger length than the destination buffer\\"));
	    }' unless defined(&__fortify_clang_warn_if_dest_too_small);
	    eval 'sub __fortify_clang_warn_if_dest_too_small0 {
	        my($__dest, $__len) = @_;
    		eval q( &__fortify_clang_warning ( &__fortify_clang_size_too_small ( &__glibc_objsize0, $__dest, $__len), \\"function called with bigger length than the destination buffer\\"));
	    }' unless defined(&__fortify_clang_warn_if_dest_too_small0);
	} else {
	    eval 'sub __fortify_use_clang () {0;}' unless defined(&__fortify_use_clang);
	    eval 'sub __fortify_clang_warning {
	        my($__c, $__msg) = @_;
    		eval q();
	    }' unless defined(&__fortify_clang_warning);
	    eval 'sub __fortify_clang_warning_only_if_bos0_lt {
	        my($__n, $__buf, $__complaint) = @_;
    		eval q();
	    }' unless defined(&__fortify_clang_warning_only_if_bos0_lt);
	    eval 'sub __fortify_clang_warning_only_if_bos0_lt2 {
	        my($__n, $__buf, $__div, $complaint) = @_;
    		eval q();
	    }' unless defined(&__fortify_clang_warning_only_if_bos0_lt2);
	    eval 'sub __fortify_clang_warning_only_if_bos_lt {
	        my($__n, $__buf, $__complaint) = @_;
	    ...
	    eval 'sub __fortify_clang_warning_only_if_bos_lt2 {
	        my($__n, $__buf, $div, $__complaint) = @_;
    		eval q();
	    }' unless defined(&__fortify_clang_warning_only_if_bos_lt2);
	    eval 'sub __fortify_clang_overload_arg {
	        my($__type, $__attr, $__name) = @_;
    		eval q($__type $__attr $__name);
	    }' unless defined(&__fortify_clang_overload_arg);
	    eval 'sub __fortify_clang_overload_arg0 {
	        my($__type, $__attr, $__name) = @_;
    		eval q( &__fortify_clang_overload_arg ($__type, $__attr, $__name));
	    }' unless defined(&__fortify_clang_overload_arg0);
	    eval 'sub __fortify_clang_warn_if_src_too_large {
	        my($__dest, $__src) = @_;
    		eval q();
	...
	if(!(defined(&__fortify_use_clang) ? &__fortify_use_clang : undef)) {
	    ...
	    eval 'sub __glibc_fortify () {( &f,  &__l,  &__s,  &__osz, ...) ( &__osz == ( &__SIZE_TYPE__) -1) ?  &__   &f   &_alias ( &__VA_ARGS__) :  &__   &f   &_chk ( &__VA_ARGS__,  &__osz);}' unless defined(&__glibc_fortify);
	}
	if(!(defined(&__fortify_use_clang) ? &__fortify_use_clang : undef)) {
	    ...
	    eval 'sub __glibc_fortify_n () {( &f,  &__l,  &__s,  &__osz, ...) ( &__osz == ( &__SIZE_TYPE__) -1) ?  &__   &f   &_alias ( &__VA_ARGS__) :  &__   &f   &_chk ( &__VA_ARGS__, ( &__osz) / ( &__s));}' unless defined(&__glibc_fortify_n);
	}
    }
	...
	unless(defined(&__REDIRECT_FORTIFY)) {
	    eval 'sub __REDIRECT_FORTIFY () { &__REDIRECT;}' unless defined(&__REDIRECT_FORTIFY);
	}
	unless(defined(&__REDIRECT_FORTIFY_NTH)) {
	    eval 'sub __REDIRECT_FORTIFY_NTH () { &__REDIRECT_NTH;}' unless defined(&__REDIRECT_FORTIFY_NTH);
	}
    }
    if(!(defined (&__GNUC__) || defined (&__clang__))) {
	...
	if(defined(&__REDIRECT)) {
	    ...
	    eval 'sub __REDIRECT_LDBL {
	        my($name, $proto, $alias) = @_;
    		eval q($name $proto  &__asm ( &__ASMNAME (\\"__\\" $alias \\"ieee128\\")));
	...
	eval 'sub __attribute_struct_may_alias__ () { &__attribute__ (( &__may_alias__));}' unless defined(&__attribute_struct_may_alias__);
    } else {
	eval 'sub __attribute_struct_may_alias__ () {1;}' unless defined(&__attribute_struct_may_alias__);
    }
}
1;
